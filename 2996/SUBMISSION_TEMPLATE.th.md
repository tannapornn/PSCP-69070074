...
```input ของข้อนี้คือตัวอักษรภาษาอังกฤษ5ตัว โดยที่ output ตัวอักษรทั้ง5ตัวต้องสลับตำแหน่งจากหลังไปหน้าแล้วก็ต้องเป็นตัวพิมพ์เล็กทั้งหมด```
...
```
Step 1:ทำความเข้าใจกับโจทย์ที่ได้มา
Step 2:ดู input และ output ที่โจทย์ต้องการ
Step 3:ลองเขียนcodeขึ้นมา
...
```หลังจากที่เขียนcodeแรกไปก็มานึกได้ว่าในโจทย์ต้องการinputที่มีแค่5ตัวอักษรเลยมาแก้codeและเพิ่มconditionเพื่อกำหนดให้inputรับแค่5ตัวถึงจะprintออกมาได้``
...
```เพื่อทดสอบว่าตัวพิมพ์ใหญ่จะแปลงเป็นตัวพิมพ์เล็กต่อให้อยู่ในประโยคที่มีตัวพิมพ์เล็กอยู่แล้ว```
...
```เพื่อทดสอบว่า input ที่ได้รับมามีแค่5ตัวอักษรและ output จะ Print"Error" ออกมาถ้าเกิน5ตัวอักษร```
...
```เพื่อทดสอบว่า input ที่ได้มาหากเป็นตัวพิมพ์ใหญ่ทั้งหมดจะถูกเปลี่ยนเป็นตัวพิมพ์เล็กทุกตัว```
...
```เข้าใจ concept ของโจทย์ด้วยตัวเองแล้วก็เขียน code ด้วยตนเอง```
